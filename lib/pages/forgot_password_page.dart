  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Введите адрес электронной почты, связанный с вашей учетной записью, и мы отправим вам код восстановления',
          textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          'Мы отправили 6-значный код на email ${widget.email}',
          textAlign: TextAlign.center,
          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
            color: Theme.of(context).colorScheme.onSurfaceVariant,
          ),
